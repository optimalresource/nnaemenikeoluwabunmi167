...
export class UpdateIncidentComponent implements OnInit {
  ...
  constructor(public searchService: SearchService, public route: ActivatedRoute, toasterService: ToasterService, public router: Router, public genericService: GenericService, public vs: VisualizeDataService) {
  ...
  pushToStore(result) {
    this.vs.changeStaffInfo(result);
  }
