...
@Component({
  selector: 'app-patrol-member-details',
  templateUrl: './patrol-member-details.component.html',
  styleUrls: ['./patrol-member-details.component.css']
})
export class PatrolMemberDetailsComponent implements OnInit {
  success;
  patrolMemberData;
  ...
  getDetails() {
    ...
    this.genericService.getOne(data).subscribe(
      res => {
        ...
        console.log(this.patrolMemberData)
      }, (err) => {
        console.log(err);
